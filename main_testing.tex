...
\subsection{Position in the results}
...
During five months of collecting the data, this user has successfully used Hstr 121 times and our history search application 69 times. For each of these data points we know what command line entry the user executed. \redtext{12 thousand of history lines}
...
%To normalize the values we divide them by the total number of possible searches.
