...
\redtext{This is some bad intro}
In this section, we explore standard shell history features. % which are most likely available to the majority our target users. 
