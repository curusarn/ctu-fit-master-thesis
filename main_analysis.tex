...
%These features are most likely available to the majority of our target users. %Standard shell history features shape how people use shell history. 
...
\subsection{Blindly retrieving very recent history entries}
...
In the example above, the user wants to remotely log in to a \verb|thumbnail api| server in the development environment using \verb|ssh|. 
