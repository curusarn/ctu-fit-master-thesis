...
%This is true for any design but it is especially important for features integrated into shell. Discoverability is very bad in shell because available features are invisible.
...
Finally, we come back to the initial requirements. We go through all of them and we explain how our design fulfills them.
