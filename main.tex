...
% why is it so hard to render tilde in Latex

\usepackage[formats]{listings}

\lstdefineformat{R}{~=\( \sim \)}
\lstset{basicstyle=\ttfamily,format=R,columns=fixed,basewidth=0.5em}
...
There are many situations where our solution outperforms Hstr. It requires less knowledge and less typing when searching. Our solution, on average, saves more typed characters to the user. 
