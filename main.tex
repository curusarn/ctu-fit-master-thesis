...
\todo{ALT: In this thesis we explore the possibilities of using the contextual information to increase the usability of standard shell history.}
...
%\begin{figure}
%  \tmpframe{\includegraphics[width=\linewidth]{figures/misc/plot_so_dev-primary-os.png}}
%  \caption{Developers' Primary Operating Systems from \cite{stackoverflow2019devsurvey-os} (87,851 responses)}
%\end{figure}
