...
When the CI pipeline builds the binaries it creates a new release on the release page\cite{resh-github-releases}. Built binaries are available on this page. 
...
Tab completions for \verb|reshctl| are set up during installation. The  \verb|-h|/\verb|--help| option with descriptions for individual subcommands is also available. To make it easy to provide all this, we use a library\cite{lib-go-cobra} for creating command line interfaces.
