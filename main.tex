...
Nevertheless, not all of the sequential contextual information is difficult to interpret and use. Sequences of history entries are useful because there are situations when people want to repeat them\redtext{REF: sequential workflow}. We should support such workflows.
...
From the perspective of Human-centered design, the interaction between the user and the history system is everything. It is essential for informing design decisions and estimating usefulness of the system. Interactions can help us understand when the system works and when it does not.
