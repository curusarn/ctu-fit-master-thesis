...
\section{Standard history features}
...
\section{Matching the state of the art / main vision / ctrl-r}
...
\section{Enhancing Resh-cli with context}
...
\todo{Intro people so they have the full picture -}
\todo{Write down what was necessary to actually do and use it as a primary structure}

\todo{Ctrl-R: Weighted sum with specific weights determined by experiments}
