...
\todo{Not sure if this is the right place - isn't this essentiall what we need for the description of standard shell features???}
...
\paragraph{History prefix search}
...
The interactions between the user and the history system can help us understand how people use history. They are essential for informing design decisions and estimating usefulness of the system. Interactions can help us understand when the system works and when it does not.
